 ...
 * <p>
 * This class is a slightly modified version of {@link tools.vitruv.framework.domains.DefaultStateBasedChangeResolutionStrategy DefaultStateBasedChangeResolutionStrategy}.
 * It is modified in such a way that its diff computation can be changed by providing a different <code>differencesProvider</code>.
 */
